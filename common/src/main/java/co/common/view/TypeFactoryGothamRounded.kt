...
class TypeFactoryGothamRounded(context: Context) {
    ...
    val regularTypeFace: Typeface = Typeface.createFromAsset(context.assets,
        GOTHAM_ROUNDED_REGULAR
    )
    val boldTypeFace: Typeface = Typeface.createFromAsset(context.assets,
        GOTHAM_ROUNDED_BOLD
    )
