...
fun String?.fromStatusCodeToDisplayable(): String? {
    return when (this) {
        ...
        ContainerOrderState.WAIT_PICKUP.name -> Utility.getInstance().getString(R.string.container_status_wait_pickup)
        ...
        ContainerOrderState.CONFIRM_PICK_UP.name -> Utility.getInstance().getString(R.string.container_status_confirm_pickup)
